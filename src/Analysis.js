  ...
  render() {
    return (
      <div>
        ...
        <p>The Pie Chart shows that out of our 15 user pool 60% used the software “Messenger”. Whereas only 33.3% used “Air Drop” and only 6.7% used “Email”. From these results we can see that Messenger was the prefered photo sharing software out of the available photo sharing softwares.</p>
        <p>From our observations into software preference we looked into repeatability. Such as whether or not users would use their chosen software again. In addition we recorded which users used what software.</p>
        <img src={PieGraphTable} width={650} height={400} mode='fit' alt="Pie Graph" />;
        <p>Through our questioning, we found that 90% of users would use the software again. To understand why they would want to use it again, we questioned them on their reasoning behind using it. From our questioning, we learned that the reason is that it is intuitive and accessible.<br></br> This information was backed up by the previous question asking them about their experience going through the process of sharing a photo using their preferred software.</p>
        <img src={PieGraphEasy} width={650} height={400} mode='fit' alt="Pie Graph" />;
        <p>From this graph, we can note that the 20% mark was from users who used AirDrop, that commented on the fact that it is the simplest way of sharing photos for iPhone users. <br></br>The 10% for “Hard” came from the one user that used Email to send a photo, who noted that there are probably faster ways of sharing images to other people. With the majority consensus of the process being “Very Easy” coming from the users who used the software Messenger to share an image.</p>
